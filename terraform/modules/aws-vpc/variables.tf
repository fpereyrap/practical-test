...
variable "route_transit_gateway" {
  description = "Should be true if you want to enable a Transit Gatway for routing in each of your private networks"
  default     = false
}

variable "transit_gateway_id" {
  description = "Transit gateway id to assign to private route table"
  default     = ""
}
...
variable "secrets_manager_endpoint_private_dns_enabled" {
...
variable "vpc_endpoint_s3_tags" {
  description = "Additional tags for the VPC s3 endpoint"
  default     = {}
}

variable "vpc_endpoint_secrets_manager_tags" {
  description = "Additional tags for the VPC Secrets Manager endpoint"
  default     = {}
}

variable "vpc_endpoint_dynamodb_tags" {
  description = "Additional tags for the VPC DynamoDb endpoint"
  default     = {}
}

variable "vpc_endpoint_ssm_tags" {
  description = "Additional tags for the VPC ssm endpoint"
  default     = {}
}

variable "vpc_endpoint_ec2_tags" {
  description = "Additional tags for the VPC ec2 endpoint"
  default     = {}
}
...
variable "manage_default_security_group" {
  description = "Should be true to adopt and manage Default SG"
  default     = false
}
...
variable "enable_api_gateway_endpoint" {
  description = "Should be true if you want to provision an apigateway endpoint to the VPC"
  default     = false
}

variable "vpc_endpoint_api_gateway_tags" {
  description = "Additional tags for the VPC api gateway endpoint"
  default     = {}
}
